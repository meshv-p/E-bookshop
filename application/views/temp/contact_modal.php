    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="social-icon">
            ...
            <span><a href="https://www.facebook.com/" title="Facebook" class="text-primary"><i class="fab fa-facebook"></i></a></span>
            <span><a href="mail:user@gmail.com" title="Mail" class="text-danger"><i class="fas fa-envelope"></i></a></span>
            <span><a href="#" title="Whatsapp" class="text-success"><i class="fab fa-whatsapp"></i></a></span>
        </div>
        <br>
        <div>
            <h6>Thanks & Regards</h6>
            <p>Project Developer of Bookshop and E-learning.</p>
        </div>
      </div>
