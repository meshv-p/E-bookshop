        ...
        <div class="row">
            <div class="col-sm-6 ofsett-3">
                ...
                <div class="social-links">
                      <?= anchor("https://www.facebook.com/", '<i class="fab fa-facebook ic"></i>',['title'=>'Facebook', 'target'=>'_blank']); ?>
                      <?= anchor("https://github.com/", '<i class="fab fa-github ic"></i>',
                      ['title'=>'gitHub', 'target'=>'_blank']); ?>
                      <?= anchor("https://www.instagram.com/", '<i class="fab fa-instagram"></i>', ['title'=>'Instagram', 'target'=>'_blank']); ?>
                </div>
            </div>
        </div>
    </div>
